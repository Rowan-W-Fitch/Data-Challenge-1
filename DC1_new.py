...
class review:
    def __init__(self,pos,neg,exc,words):
        ...
        self.features.append(neg)
        if exc:
            self.features.append(1)
        else:
            self.features.append(0)
        self.features.append(math.log(words,10))
...
class folder_reader:
    ...
    def read_folder(self, path, label):
        #label is the labeled sentiment of review, remove parameter for final
        ...
        for file in glob.glob(path):
            ...
            for line in f:
                ...
                for x,y in tags:
                    if self.avg_senti(self,x,y) == 1:
                        pos += 1
                    elif self.avg_senti(self,x,y) == 0:
                        neg+=1
